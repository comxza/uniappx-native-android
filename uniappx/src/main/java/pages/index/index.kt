...
import uts.sdk.modules.yxTest.test;
import uts.sdk.modules.yxTest.register;
open class GenPagesIndexIndex : BasePage {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", null, utsArrayOf(
            ...
            createElementVNode("view", utsMapOf("class" to "text-area"), utsArrayOf(
                ...
                createElementVNode("button", utsMapOf("type" to "default", "onClick" to _ctx.qqlogin), "qqlogin", 8, utsArrayOf(
                    "onClick"
                ))
            )),
            " wq "
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("title" to "Hello  1211212");
    }
    ...
    open lateinit var qqlogin: () -> Unit;
    companion object {
